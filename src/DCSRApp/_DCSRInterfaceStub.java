...
/**
* DCSRApp/_DCSRInterfaceStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Modules.idl
* Sunday, November 4, 2018 at 9:57:55 PM Eastern Standard Time
*/

public class _DCSRInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements DCSRApp.DCSRInterface
{
  ...
  public String addCourse (String courseID, String semester, int capacity, String desc)
  {
            ...
            try {
                ...
                return addCourse (courseID, semester, capacity, desc        );
            } finally {
                _releaseReply ($in);
            }
  } // addCourse
  ...
  public String[] CourseAvailability (String semester)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("CourseAvailability", true);
                $out.write_string (semester);
                $in = _invoke ($out);
                String $result[] = DCSRApp.arrayHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                return CourseAvailability (semester        );
            } finally {
                _releaseReply ($in);
            }
  } // CourseAvailability
  ...
  public String addUserToEnrolledUser (String name, String id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("addUserToEnrolledUser", true);
                ...
                return addUserToEnrolledUser (name, id        );
            } finally {
                _releaseReply ($in);
            }
  } // addUserToEnrolledUser

  public boolean hasCapacity (String courseID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("hasCapacity", true);
                $out.write_string (courseID);
                $in = _invoke ($out);
