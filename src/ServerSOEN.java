...
public class ServerSOEN {
    public static ImplSOEN SOENObj;
    public static void main(String args[]) throws Exception
    {
        ...
        public static void StartServer (String args[]) {
            ...
            try {
                ...
                SOENObj = new ImplSOEN();
                SOENObj.setORB(orb);

                // get object reference from the servant
                org.omg.CORBA.Object ref = rootpoa.servant_to_reference(SOENObj);
                ...
                System.out.println("SOEN Server is ready and waiting ...");
