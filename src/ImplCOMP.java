import DCSRApp.DCSRInterfacePOA;
...
public class ImplCOMP extends DCSRInterfacePOA

{
   ...
   // Database db;
    ...
    public ImplCOMP() throws IOException
    {
        //super();
        ...
        logger = Logger.getLogger("COMP-Server");
        fh = new FileHandler("/Users/veedaa/Desktop/CORBA/src/Logs/COMP.log");
    ...
    public String removeCourse(String courseID, String semester)  {
        ...
        else if(getOuter_map().containsKey(semester))
        {
            if(semester.toLowerCase().equals("summer"))
            {
                ...
                result = "Course successfully dropped!";
                System.out.println(result);
                 ...
                 if(course.getEnrolledUsers().size() < course.getCapacity())
                    {
                        ...
                        {
                            result= "This student already has this course!";
                            System.out.println(result);
