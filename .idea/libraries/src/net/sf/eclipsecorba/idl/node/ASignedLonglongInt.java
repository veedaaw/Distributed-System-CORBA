...
public final class ASignedLonglongInt extends PSignedLonglongInt
{
    private TLong _left_;
    private TLong _right_;

    public ASignedLonglongInt()
    {
    }
    ...
    {
        ((Analysis) sw).caseASignedLonglongInt(this);
    }
