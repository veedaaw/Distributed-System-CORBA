...
public final class AExceptDcl extends PExceptDcl
{
    ...
    public Object clone()
    {
        return new AExceptDcl(
            (TException) cloneNode(_exception_),
    ...
    {
        ((Analysis) sw).caseAExceptDcl(this);
    }
    ...
    public void setException(TException node)
    {
        if(_exception_ != null)
        {
            _exception_.parent(null);
        }
    ...
    {
        if(_exception_ == oldChild)
        {
            setException((TException) newChild);
            return;
        }
