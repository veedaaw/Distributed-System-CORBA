...
public final class AUshortSwitchTypeSpec extends PSwitchTypeSpec
{
    private PUnsignedShortInt _unsignedShortInt_;

    public AUshortSwitchTypeSpec()
    {
    }
    ...
    public Object clone()
    {
        return new AUshortSwitchTypeSpec(
            (PUnsignedShortInt) cloneNode(_unsignedShortInt_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAUshortSwitchTypeSpec(this);
    }
