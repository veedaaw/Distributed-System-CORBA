...
public final class AStructForwardDcl extends PStructForwardDcl
{
    private TStruct _struct_;
    private TIdentifier _identifier_;

    public AStructForwardDcl()
    {
    }
    ...
    {
        ((Analysis) sw).caseAStructForwardDcl(this);
    }
