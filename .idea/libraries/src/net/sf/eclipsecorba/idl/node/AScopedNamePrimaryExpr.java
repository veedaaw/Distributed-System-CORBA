...
public final class AScopedNamePrimaryExpr extends PPrimaryExpr
{
    private PScopedName _scopedName_;

    public AScopedNamePrimaryExpr()
    {
    }
    ...
    public Object clone()
    {
        return new AScopedNamePrimaryExpr(
            (PScopedName) cloneNode(_scopedName_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAScopedNamePrimaryExpr(this);
    }
