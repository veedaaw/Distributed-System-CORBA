...
public final class ALonglongSwitchTypeSpec extends PSwitchTypeSpec
{
    private PSignedLonglongInt _signedLonglongInt_;

    public ALonglongSwitchTypeSpec()
    {
    }
    ...
    public Object clone()
    {
        return new ALonglongSwitchTypeSpec(
            (PSignedLonglongInt) cloneNode(_signedLonglongInt_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALonglongSwitchTypeSpec(this);
    }
