...
public final class AScopedSwitchTypeSpec extends PSwitchTypeSpec
{
    private PScopedName _scopedName_;

    public AScopedSwitchTypeSpec()
    {
    }
    ...
    public Object clone()
    {
        return new AScopedSwitchTypeSpec(
            (PScopedName) cloneNode(_scopedName_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAScopedSwitchTypeSpec(this);
    }
