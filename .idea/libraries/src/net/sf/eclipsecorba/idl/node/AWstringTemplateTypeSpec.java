...
public final class AWstringTemplateTypeSpec extends PTemplateTypeSpec
{
    private PWideStringType _wideStringType_;

    public AWstringTemplateTypeSpec()
    {
    }
    ...
    public Object clone()
    {
        return new AWstringTemplateTypeSpec(
            (PWideStringType) cloneNode(_wideStringType_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAWstringTemplateTypeSpec(this);
    }
