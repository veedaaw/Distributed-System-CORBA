...
public final class APrimaryExprUnaryExpr extends PUnaryExpr
{
    private PPrimaryExpr _primaryExpr_;

    public APrimaryExprUnaryExpr()
    {
    }
    ...
    public Object clone()
    {
        return new APrimaryExprUnaryExpr(
            (PPrimaryExpr) cloneNode(_primaryExpr_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAPrimaryExprUnaryExpr(this);
    }
