...
public final class AWideStringTypeConstType extends PConstType
{
    private PWideStringType _wideStringType_;

    public AWideStringTypeConstType()
    {
    }
    ...
    public Object clone()
    {
        return new AWideStringTypeConstType(
            (PWideStringType) cloneNode(_wideStringType_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAWideStringTypeConstType(this);
    }
