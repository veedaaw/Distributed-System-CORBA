...
public final class AScopedParamTypeSpec extends PParamTypeSpec
{
    private PScopedName _scopedName_;

    public AScopedParamTypeSpec()
    {
    }
    ...
    public Object clone()
    {
        return new AScopedParamTypeSpec(
            (PScopedName) cloneNode(_scopedName_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAScopedParamTypeSpec(this);
    }
