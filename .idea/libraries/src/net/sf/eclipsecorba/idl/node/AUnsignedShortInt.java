...
public final class AUnsignedShortInt extends PUnsignedShortInt
{
    private TUnsigned _unsigned_;
    private TShort _short_;

    public AUnsignedShortInt()
    {
    }
    ...
    {
        ((Analysis) sw).caseAUnsignedShortInt(this);
    }
